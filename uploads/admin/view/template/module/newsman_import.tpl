	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo 'Edit ' . $heading_title . ' Module'; ?></h3>
			</div>
					...
					<?php if($isOauth) { ?>
						<div id="contentOauth">
							...
							<div style="padding-top: 5px;">
								<a style="background: #ad0100" href="<?php echo $oauthUrl; ?>" class="button button-primary btn btn-primary">Login with NewsMAN</a>
							</div>
							</form>
						...
						<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
							<div class="form-group">
								...
								<div>
									...
									<input class="form-control" type="hidden" value="2" name="step">
									<label for="api_key"><?php echo $entry_api_key; ?>: </label><br>
									<input style="width: 250px;" class="form-control" type="text" value="<?php echo isset($settings['api_key'])?$settings['api_key']:''; ?>" name="api_key" id="api_key" placeholder="<?php echo $entry_api_key; ?>"><br><br>
									<label for="user_id"><?php echo $entry_user_id; ?>: </label><br>
									<input style="width: 250px;" class="form-control" type="text" value="<?php echo isset($settings['user_id'])?$settings['user_id']:''; ?>" name="user_id" id="user_id" placeholder="<?php echo $entry_user_id; ?>"><br><br>
									<a onclick="connectNewsman();" class="btn btn-default"><span><?php echo $button_connect; ?></span></a>
								...
								<div>
									...
									<div style="display:  <?php echo isset($settings['import_type']) && $settings['import_type']==2 ?'block':'none'; ?>" id="importTypeList">
										<table class="form" id="cgtable">
                                            ...
                                            echo '<tr><td style="padding: 5px;" data-id="'.$cg['customer_group_id'].'">'.$cg['name'].'</td><td style="padding: 5px;">'.$text_import_in.'</td><td style="padding: 5px;"></td></tr>';
											} ?>
											</tbody>
										</table>
										<input class="form-control" type="hidden" value="" name="segments" id="segments">
										<a onclick="try_submit();" class="btn btn-default"><span><?php echo $button_save; ?></span></a>
									</div>
									<br>
									<p><?php echo $text_sync; ?></p>
									<a onclick="sync();" class="btn btn-default"><span><?php echo $button_sync_now; ?></span></a>
									<input class="form-control" type="hidden" value="0" name="sync" id="sync">
